        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleMeetLink = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Epics_Users_ProductOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BugSeverity = table.Column<int>(type: "integer", nullable: true),
                    BugProbability = table.Column<int>(type: "integer", nullable: true),
                    ReportedEnvironment = table.Column<int>(type: "integer", nullable: true),
                    BuildCrash = table.Column<bool>(type: "boolean", nullable: true),
                    ProductionImpacted = table.Column<bool>(type: "boolean", nullable: true),
                    TrendingEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    TargetForSprint = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UserStories_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_WorkspaceId_ProjectId_EntityType_EntityId",
                table: "Comments",
                columns: new[] { "WorkspaceId", "ProjectId", "EntityType", "EntityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_WorkspaceId_UserId_IsRead_CreatedAt",
                table: "Notifications",
                columns: new[] { "WorkspaceId", "UserId", "IsRead", "CreatedAt" });
